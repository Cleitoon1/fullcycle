Repo: https://github.com/devfullcycle/fc-monolito/tree/main

Não necessariamente uma aplicação de grande porta é uma aplicação distribuída

Estrutura do projeto

Code Store - Contextos:
 - Product-Adm
 - Checkout
 - Store-Catalog
 - Payment
